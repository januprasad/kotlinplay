...
const val NOTIFICATION_CHANNEL_ID = "com.example.work_manager_example" + ".channel"
...
fun sendNotification(context: Context) {
    ...
    val intent = WorkManagerActivity.newIntent(context.applicationContext)

    // create a pending intent that opens MainActivity when the user clicks on the notification
    val stackBuilder =
        TaskStackBuilder
            .create(context)
            .addParentStack(WorkManagerActivity::class.java)
