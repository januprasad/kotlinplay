package com.example.bitcoinj_utils.tx

import com.example.bitcoinj_utils.tx.model.TxOutputData
import com.example.bitcoinj_utils.tx.model.UtxoData
    ...
    constructor(
        ...
        fun signHex(
            ...
            tx.inputs.forEachIndexed { i, input ->
                ...
                val utxo =
                    utxoMap[UtxoData.getUtxoUid(outpoint.hash.toString(), outpoint.index)]
