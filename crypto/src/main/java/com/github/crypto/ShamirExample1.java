...
public final class ShamirExample1 {
    ...
    public ShamirExample1(final int k, final int n) {
        this.k = k;
        this.n = n;
    ...
    public static void main(final String[] args) {
        ...
        final ShamirExample1 shamir2 = new ShamirExample1(3, 12);
        final BigInteger result = shamir2.combine(shares, prime);
        System.out.println("resultant prime "+result);
